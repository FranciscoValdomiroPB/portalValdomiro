...
--
-- Host: 127.0.0.1
-- Tempo de geração: 25/05/2023 às 00:49
...
INSERT INTO `pousada` (`id_pousada`, `id_administrador`, `nome`, `descricao`, `endereco`, `numero_quartos`, `preco_noite`, `fotos`) VALUES
(1, NULL, 'POUSADA TUCANO', 'Localizada bem no centro de Presidente Figueiredo-AM, a Pousada Tucanos oferece conforto e\n					tranquilidade\n					para os seus hóspedes. São diversos quartos com ar-condicionado, TV, Wi-fi e\n					fri', ' Av. Maçaranduba, 606-704 - Honório Roldão', 1, 100.00, 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/06/89/2e/2f/pousada-tucano.jpg?w=400&amp;h=-1&amp;s=1 1x,https://dynamic-media-cdn.tripadvisor.com/media/photo-o/06/89/2e/2f/pousada-tucano.jpg?'),
(2, NULL, 'Local Hostel', 'O hostel é uma delícia, o atendimento e café da manhã bem completo, a Local Hostel é o lugar perfeito para quem busca descanso e diversão. São diversos quartos, equipados com ar-condicionado, TV e fri', 'Av. Pe Calleri, 60 - Tancredo Neves', NULL, NULL, 'https://media-cdn.tripadvisor.com/media/photo-s/14/ec/fb/e2/local-hostel-figueiredo.jpg'),
(3, NULL, 'Pousada 1 lugar', 'Ambiente bem instagramaveis, a Pousada 1 lugar oferece um clima agradável e uma vista deslumbrante. São diversos chalés equipados com ar-condicionado, TV e frigobar. Além disso, a pousada conta com Wi', 'BR 174 - KM 1004', NULL, NULL, 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1c/1f/ce/26/hotel-1-lugar.jpg?w=1200&amp;h=-1&amp;s=1 1x,https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1c/1f/ce/26/hotel-1-lugar.jpg?w');
...
CREATE TABLE `restaurante` (
  ...
  `descricao` varchar(200) DEFAULT NULL,
  `endereco` varchar(200) DEFAULT NULL,
  `endereço_link` varchar(200) DEFAULT NULL,
...
INSERT INTO `restaurante` (`id_restaurante`, `id_administrador`, `nome`, `descricao`, `endereco`, `endereço_link`, `faixa_preco`, `contato`, `fotos`) VALUES
(1, NULL, 'Restaurante Papaleguas', NULL, 'Praça da Cultura, BOX 01 Avenida Sucupira,Centro.', 'https://www.google.com/maps/place/Restaurante+Papal%C3%A9guas/@-2.0519608,-60.0259574,17z/data=!3m1!4b1!4m6!3m5!1s0x927205f8724b71fd:0x4ffcd1b577fb48b4!8m2!3d-2.0519608!4d-60.0259574!16s%2Fg%2F11c74f7', NULL, '092992689498', 'https://lh3.googleusercontent.com/p/AF1QipO2jDlPIaR7yBzefs9mbiuQ6Zslf_vcIsukft6V=s680-w680-h510');
